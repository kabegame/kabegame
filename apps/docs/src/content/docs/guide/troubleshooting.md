...
- **原因**：商店源 URL 不可达。
- **操作**：到插件源管理中确认源 URL 是否可达、切换或移除失效源；必要时在系统层面启用代理。详见 [插件商店](/guide/plugins-usage/)。
...
- **操作**：在桌面版（Windows / macOS / Linux）使用虚拟盘。详见 [安装](/guide/installation/)。
...
- [插件商店](/guide/plugins-usage/)：插件源配置与安装
