...
| OS | Standard | Light |
|----|----------|-------|
| Windows | [setup.exe](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-standard_3.4.4_x64-setup.exe) | [setup.exe](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-light_3.4.4_x64-setup.exe) |
| macOS | [dmg](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-standard_3.4.4_aarch64.dmg) | [dmg](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-light_3.4.4_aarch64.dmg) |
| Linux | [deb](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-standard_3.4.4_amd64.deb) | [deb](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame-light_3.4.4_amd64.deb) |

- **Android preview** : [apk](https://github.com/kabegame/kabegame/releases/download/v3.4.4/Kabegame_3.4.4_android-preview.apk) on the same releases page.
