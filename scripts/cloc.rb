...
# 默认配置
DEFAULT_PATH = '.'
DEFAULT_EXCLUDE = 'node_modules,dist,build,.git,target,release,photoswipe-vue/src/js,third,ignore,tmp,.tmp,bin,.kabegame,kabegame-element-plus,kabegame-element-plus-icon'
