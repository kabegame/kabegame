...
- **Android プレビュー**（Light のみ）：[kabegame_3.2.0_android-preview.apk](https://github.com/kabegame/kabegame/releases/download/v3.2.0/Kabegame_3.2.0_android-preview.apk)
