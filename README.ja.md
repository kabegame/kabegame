...
Tauri ベースのアニメ画像マネージャー！壁紙をクロール・管理・設定・ローテーション。推しの画像たちで毎日癒やされよう～ プラグインで拡張可能、様々なアニメ壁紙サイトから簡単に画像を取得できます。
...
- **Android プレビュー**：[apk](https://github.com/kabegame/kabegame/releases/download/v3.4.0/Kabegame_3.4.0_android-preview.apk)（同一リリースページ）。
