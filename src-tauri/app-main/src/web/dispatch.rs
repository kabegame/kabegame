...
pub fn init_registry() {
    ...
    map.insert("get_album_preview", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { album_id: String, limit: usize }
    ...
    map.insert("get_album_image_ids", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_images_count", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_gallery_plugin_groups", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_gallery_media_type_counts", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_album_media_type_counts", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_gallery_time_filter_data", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_image_by_id", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { image_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("get_image_metadata", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_image_metadata_by_metadata_id", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { metadata_id: i64 }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("get_all_tasks", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_run_configs", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_run_config", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { config_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("get_missed_runs", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_active_downloads", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_task_logs", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_task_failed_images", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_all_failed_images", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_plugins", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_plugin_detail", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { plugin_id: String, source_id: Option<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("get_plugin_sources", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_store_plugins", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("get_remote_plugin_icon", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("proxy_fetch", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args {
    ...
    map.insert("get_favorite_album_id", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_favorite_album_id().map_err(RpcError::internal)
        })),
    });

    map.insert("get_import_recommended_schedule_enabled", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_import_recommended_schedule_enabled().map_err(RpcError::internal)
        })),
    });

    map.insert("get_max_concurrent_downloads", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_max_concurrent_downloads().map_err(RpcError::internal)
        })),
    });

    map.insert("get_max_concurrent_tasks", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_max_concurrent_tasks().map_err(RpcError::internal)
        })),
    });

    map.insert("get_download_interval_ms", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_download_interval_ms().map_err(RpcError::internal)
        })),
    });

    map.insert("get_network_retry_count", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_network_retry_count().map_err(RpcError::internal)
        })),
    });

    map.insert("get_auto_deduplicate", MethodEntry {
        requires_super: false,
        handler: Arc::new(|_p| Box::pin(async move {
            crate::commands_core::settings::get_auto_deduplicate().map_err(RpcError::internal)
        })),
    });

    // ── write (super required) ────────────────────────────────────────────────

    map.insert("start_task", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { task: Value }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("refresh_plugins", MethodEntry {
        requires_super: true,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("get_plugin_default_config", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { plugin_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("ensure_plugin_default_config", MethodEntry {
        requires_super: false,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("save_plugin_default_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { plugin_id: String, config: serde_json::Value }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::plugin::save_plugin_default_config(args.plugin_id, args.config)
                .await
                .map_err(RpcError::internal)
        })),
    });

    map.insert("reset_plugin_default_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("delete_image", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("batch_delete_images", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { image_ids: Vec<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("batch_remove_images", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("remove_image", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("move_album", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { album_id: String, new_parent_id: Option<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("add_album", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { name: String, parent_id: Option<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("add_images_to_album", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { album_id: String, image_ids: Vec<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("add_task_images_to_album", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { task_id: String, album_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::album::add_task_images_to_album(args.task_id, args.album_id)
                .await
                .map_err(RpcError::internal)
        })),
    });

    map.insert("remove_images_from_album", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { album_id: String, image_ids: Vec<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::album::remove_images_from_album(args.album_id, args.image_ids)
                .await
                .map_err(RpcError::internal)
        })),
    });

    map.insert("update_album_images_order", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { album_id: String, image_orders: Vec<(String, i64)> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::album::update_album_images_order(args.album_id, args.image_orders)
                .await
                .map_err(RpcError::internal)
        })),
    });
    ...
    map.insert("cancel_task", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("delete_task", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("add_task", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { task: Value }
    ...
    map.insert("update_task", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { task: Value }
    ...
    map.insert("clear_finished_tasks", MethodEntry {
        requires_super: true,
        handler: Arc::new(|_p| Box::pin(async move {
    ...
    map.insert("copy_run_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("retry_task_failed_image", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { failed_id: i64 }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("retry_failed_images", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
    ...
    map.insert("cancel_retry_failed_image", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("cancel_retry_failed_images", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { ids: Vec<i64> }
    ...
    map.insert("delete_failed_images", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { ids: Vec<i64> }
    ...
    map.insert("delete_task_failed_image", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("add_run_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { config: Value }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("update_run_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { config: Value }
    ...
    map.insert("delete_run_config", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("run_missed_configs", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { config_ids: Vec<String> }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("dismiss_missed_configs", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("delete_plugin", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("install_from_store", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { source_id: String, plugin_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("import_plugin_from_zip", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { zip_path: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("validate_plugin_source", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { index_url: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("update_plugin_source", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { id: String, name: String, index_url: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::plugin::update_plugin_source(args.id, args.name, args.index_url)
                .await
                .map_err(RpcError::internal)
        })),
    });

    map.insert("delete_plugin_source", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
    ...
    map.insert("add_plugin_source", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { id: Option<String>, name: String, index_url: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::plugin::add_plugin_source(args.id, args.name, args.index_url)
                .await
                .map_err(RpcError::internal)
        })),
    });

    map.insert("preview_import_plugin", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
    ...
    map.insert("preview_store_install", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { source_id: String, plugin_id: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::plugin::preview_store_install(args.source_id, args.plugin_id)
                .await
                .map_err(RpcError::internal)
        })),
    });
    ...
    map.insert("surf_delete_record", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { host: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("surf_update_name", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { host: String, name: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("surf_update_root_url", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { host: String, root_url: String }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("set_max_concurrent_downloads", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
    ...
    map.insert("set_max_concurrent_tasks", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { count: u32 }
    ...
    map.insert("set_download_interval_ms", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            #[serde(rename_all = "camelCase")]
            struct Args { interval_ms: u32 }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
    ...
    map.insert("set_network_retry_count", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { count: u32 }
    ...
    map.insert("set_auto_deduplicate", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
    ...
    map.insert("set_import_recommended_schedule_enabled", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
            #[derive(serde::Deserialize)]
            struct Args { enabled: bool }
            let args: Args = serde_json::from_value(p).map_err(RpcError::invalid_params)?;
            crate::commands_core::settings::set_import_recommended_schedule_enabled(args.enabled)
                .await
                .map_err(RpcError::internal)
        })),
    });
    ...
    map.insert("start_organize", MethodEntry {
        requires_super: true,
        handler: Arc::new(|p| Box::pin(async move {
