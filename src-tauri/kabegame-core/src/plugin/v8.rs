...
extension!(
    ...
    ops = [
        ...
        ops::op_kabegame_fetch_to_file,
        ops::op_kabegame_fs_root,
        ops::op_kabegame_ffmpeg_mux,
        ops::op_kabegame_ffmpeg_probe,
        ops::op_kabegame_archive_zip,
        ops::op_kabegame_archive_tar,
        ops::op_kabegame_archive_7z,
