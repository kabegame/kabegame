...
import {
  ...
  isNumber,
  isPromise,
} from '@kabegame/element-plus/utils'
import ElCascaderPanel, {
  CASCADER_PANEL_HEIGHT,
  CASCADER_PANEL_ITEM_SIZE,
} from '@kabegame/element-plus/components/cascader-panel'
...
import { FixedSizeList as ElFixedSizeList } from '@kabegame/element-plus/components/virtual-list'
...
import { ArrowDown, Check, CircleClose } from '@kabegame/element-plus-icons'
import { cascaderEmits } from './cascader'

import type { Options } from '@kabegame/element-plus/components/popper'
...
import type { ScrollbarInstance } from '@kabegame/element-plus/components/scrollbar'
import type { FixedSizeListInstance } from '@kabegame/element-plus/components/virtual-list'
import type {
  CascaderNode,
