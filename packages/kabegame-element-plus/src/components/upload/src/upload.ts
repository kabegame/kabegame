import { NOOP, buildProps, definePropType, mutable } from '@kabegame/element-plus/utils'
import { ajaxUpload } from './ajax.ts'

import type { Awaitable, Mutable } from '@kabegame/element-plus/utils'
import type { UploadAjaxError } from './ajax.ts'
