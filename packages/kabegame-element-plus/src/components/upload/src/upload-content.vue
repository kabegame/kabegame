...
import { entriesOf, isFunction, isPlainObject } from '@kabegame/element-plus/utils'
...
import { genFileId } from './upload.ts'
import { uploadContentPropsDefaults } from './upload-content.ts'

import type { UploadContentProps } from './upload-content.ts'
import type {
  UploadFile,
  UploadHooks,
  UploadRawFile,
