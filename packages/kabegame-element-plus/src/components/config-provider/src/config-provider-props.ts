import { buildProps, definePropType } from '@kabegame/element-plus/utils'
import { useEmptyValuesProps, useSizeProp } from '@kabegame/element-plus/hooks'

import type { ExtractPropTypes, ExtractPublicPropTypes } from 'vue'
import type { Language } from '@kabegame/element-plus/locale'
import type { ButtonConfigContext } from '@kabegame/element-plus/components/button'
import type { CardConfigContext } from '@kabegame/element-plus/components/card'
import type { DialogConfigContext } from '@kabegame/element-plus/components/dialog'
import type { MessageConfigContext } from '@kabegame/element-plus/components/message'
import type { LinkConfigContext } from '@kabegame/element-plus/components/link'
import type { TableConfigContext } from '@kabegame/element-plus/components/table'
