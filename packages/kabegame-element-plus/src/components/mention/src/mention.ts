...
import { UPDATE_MODEL_EVENT } from '@kabegame/element-plus/constants'
import { inputProps } from '@kabegame/element-plus/components/input'
import { filterOption } from './helper.ts'
...
import type { InputProps } from '@kabegame/element-plus/components/input'
import type { ElTooltipContentProps } from '@kabegame/element-plus/components/tooltip'
...
export type { MentionOption } from './types.ts'
