...
import { useFocusController, useId, useNamespace } from '@kabegame/element-plus/hooks'
import ElInput, { inputPropsDefaults } from '@kabegame/element-plus/components/input'
...
import { useFormDisabled } from '@kabegame/element-plus/components/form'
import { getEventCode, isArray, isFunction } from '@kabegame/element-plus/utils'
import { mentionDefaultProps, mentionEmits } from './mention.ts'
import { filterOption, getCursorPosition, getMentionCtx } from './helper.ts'
import ElMentionDropdown from './mention-dropdown.vue'

import type { MentionProps } from './mention.ts'
...
import type { MentionCtx, MentionOption } from './types.ts'
