...
import { PatchFlags, buildProps, definePropType } from '@kabegame/element-plus/utils'
import { useNamespace, useSameTarget } from '@kabegame/element-plus/hooks'
...
import type { ClassValue, ZIndexType } from '@kabegame/element-plus/utils'
