...
import { useLocale, useNamespace } from '@kabegame/element-plus/hooks'
...
import {
  ...
  extractDateFormat,
  extractTimeFormat,
} from '@kabegame/element-plus/components/time-picker'
...
import { EVENT_CODE } from '@kabegame/element-plus/constants'
import {
  ArrowLeft,
  ArrowRight,
  DArrowLeft,
...
import { panelDatePickProps } from '../props/panel-date-pick.ts'
import {
  correctlyParseUserInput,
  getValidDateOfMonth,
  getValidDateOfYear,
} from '../utils.ts'
import { ROOT_PICKER_IS_DEFAULT_FORMAT_INJECTION_KEY } from '../constants.ts'
...
import type { PanelDatePickProps } from '../props/panel-date-pick.ts'
import type {
  DateTableEmits,
  DatesPickerEmits,
  MonthsPickerEmits,
  WeekPickerEmits,
  YearsPickerEmits,
} from '../props/basic-date-table.ts'
