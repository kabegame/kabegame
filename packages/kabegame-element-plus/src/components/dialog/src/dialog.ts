import { buildProps, definePropType, isBoolean } from '@kabegame/element-plus/utils'
import { UPDATE_MODEL_EVENT } from '@kabegame/element-plus/constants'
import {
  dialogContentProps,
  dialogContentPropsDefaults,
} from './dialog-content.ts'
...
import type { DialogContentProps } from './dialog-content.ts'
