...
import { useDeprecated, useNamespace, useSameTarget } from '@kabegame/element-plus/hooks'
import ElFocusTrap from '@kabegame/element-plus/components/focus-trap'
import ElDialogContent from './dialog-content.vue'
import { dialogInjectionKey } from './constants.ts'
import { dialogEmits, dialogPropsDefaults } from './dialog.ts'
