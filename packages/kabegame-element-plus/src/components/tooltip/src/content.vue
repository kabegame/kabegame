...
import { useNamespace, usePopperContainerId } from '@kabegame/element-plus/hooks'
import {
  castArray,
  composeEventHandlers,
  focusElement,
} from '@kabegame/element-plus/utils'
import { ElPopperContent } from '@kabegame/element-plus/components/popper'
...
import type { PopperContentInstance } from '@kabegame/element-plus/components/popper'
