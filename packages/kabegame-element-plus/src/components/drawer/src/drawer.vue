...
import { dialogPropsDefaults, useDialog } from '@kabegame/element-plus/components/dialog'
import ElIcon from '@kabegame/element-plus/components/icon'
import { useDeprecated, useLocale, useNamespace } from '@kabegame/element-plus/hooks'
