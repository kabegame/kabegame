...
import { vRepeatClick } from '@kabegame/element-plus/directives'
...
import { getStyle, isNumber, rAF } from '@kabegame/element-plus/utils'
import { CHANGE_EVENT } from '@kabegame/element-plus/constants'
import {
