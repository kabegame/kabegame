import { buttonTypes } from '@kabegame/element-plus/components/button'
import { QuestionFilled } from '@kabegame/element-plus-icons'
import { buildProps, iconPropType } from '@kabegame/element-plus/utils'
import {
...
import type { ButtonType } from '@kabegame/element-plus/components/button'
import type {
