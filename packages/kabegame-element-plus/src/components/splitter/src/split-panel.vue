...
import { throwError } from '@kabegame/element-plus/utils'
import { getCollapsible, isCollapsible } from './hooks/usePanel.ts'
import SplitBar from './split-bar.vue'
import { splitterPanelEmits } from './split-panel.ts'
import { getPct, getPx, isPct, isPx } from './hooks/index.ts'
import { splitterRootContextKey } from './type.ts'

import type { SplitterPanelProps } from './split-panel.ts'
