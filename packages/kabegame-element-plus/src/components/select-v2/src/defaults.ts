...
import { tagProps } from '../../tag/index.ts'
import { defaultProps } from './useProps.ts'

import type SelectV2 from './select.vue'
import type { Option, OptionType } from './select.types.ts'
import type { Props } from './useProps.ts'
import type { EmitFn } from '@kabegame/element-plus/utils/vue/typescript'
import type {
  CSSProperties,
  ExtractPropTypes,
