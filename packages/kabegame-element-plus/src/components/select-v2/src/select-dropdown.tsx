...
import { getEventCode, isIOS, isObject, isUndefined } from '@kabegame/element-plus/utils'
import {
  DynamicSizeList,
  FixedSizeList,
} from '@kabegame/element-plus/components/virtual-list'
...
import { selectV2InjectionKey } from './token.ts'
import { scrollbarEmits } from '@kabegame/element-plus/components/scrollbar'

import type { ScrollbarDirection } from '@kabegame/element-plus/components/scrollbar'
import type {
  DynamicSizeListInstance,
  FixedSizeListInstance,
  ItemProps,
} from '@kabegame/element-plus/components/virtual-list'
import type { Option, OptionItemProps } from './select.types.ts'
import type {
