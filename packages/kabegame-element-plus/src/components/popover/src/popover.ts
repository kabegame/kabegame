import { buildProps, isBoolean } from '@kabegame/element-plus/utils'
import {
  useTooltipContentPropsDefaults,
  useTooltipProps,
  useTooltipTriggerPropsDefaults,
} from '@kabegame/element-plus/components/tooltip'
import { dropdownProps } from '@kabegame/element-plus/components/dropdown'
import { popperArrowPropsDefaults } from '@kabegame/element-plus/components/popper'
import { omit } from 'lodash-unified'

import type { UseTooltipProps } from '@kabegame/element-plus/components/tooltip'
