...
import { More } from '@kabegame/element-plus-icons'
import {
  buildProps,
  definePropType,
  flattedChildren,
...
import Menubar from './utils/menu-bar.ts'
import ElMenuCollapseTransition from './menu-collapse-transition.vue'
import ElSubMenu from './sub-menu.ts'
import { useMenuCssVar } from './use-menu-css-var.ts'
import { MENU_INJECTION_KEY, SUB_MENU_INJECTION_KEY } from './tokens.ts'

import type { ClassValue } from '@kabegame/element-plus/utils'
import type { PopperEffect } from '@kabegame/element-plus/components/popper'
import type { MenuItemClicked, MenuProvider, SubMenuProvider } from './types.ts'
