...
import { useFormItemInputId, useFormSize } from '@kabegame/element-plus/components/form'
import { useLocale, useNamespace } from '@kabegame/element-plus/hooks'
import { sliderContextKey } from './constants.ts'
import { sliderEmits, sliderProps } from './slider.ts'
import SliderButton from './button.vue'
import SliderMarker from './marker.ts'
import {
  useLifecycle,
  useMarks,
  useSlide,
...
import { isNumber } from '@kabegame/element-plus/utils'

import type { SliderInitData } from './slider.ts'
