...
import { ClickOutside as vClickOutside } from '@kabegame/element-plus/directives'
import { ElTooltip } from '@kabegame/element-plus/components/tooltip'
import { ElButton } from '@kabegame/element-plus/components/button'
import {
  useFormDisabled,
  useFormItem,
  useFormItemInputId,
  useFormSize,
} from '@kabegame/element-plus/components/form'
import {
  useEmptyValues,
  useFocusController,
  useLocale,
  useNamespace,
} from '@kabegame/element-plus/hooks'
import {
  CHANGE_EVENT,
  EVENT_CODE,
  UPDATE_MODEL_EVENT,
} from '@kabegame/element-plus/constants'
import { NOOP, getEventCode } from '@kabegame/element-plus/utils'
import { ArrowDown, Close } from '@kabegame/element-plus-icons'
import { colorPickerEmits, colorPickerPropsDefaults } from './color-picker'
import {
  ElColorPickerPanel,
  ROOT_COMMON_COLOR_INJECTION_KEY,
  colorPickerPanelProps,
} from '@kabegame/element-plus/components/color-picker-panel'
import Color from '@kabegame/element-plus/components/color-picker-panel/src/utils/color'
import { useCommonColor } from '@kabegame/element-plus/components/color-picker-panel/src/composables/use-common-color'

import type { ColorPickerPanelInstance } from '@kabegame/element-plus/components/color-picker-panel'
import type { TooltipInstance } from '@kabegame/element-plus/components/tooltip'
