...
import { messageConfig } from '@kabegame/element-plus/components/config-provider'
...
import { getOrCreatePlacementInstances, placementInstances } from './instance.ts'

import type { MessageContext } from './instance.ts'
