...
import { TrapFocus } from '@kabegame/element-plus/directives'
import {
  useDraggable,
  useId,
  useLockscreen,
...
import { ElOverlay } from '@kabegame/element-plus/components/overlay'
import {
  TypeComponents,
  TypeComponentsMap,
  isFunction,
...
import ElFocusTrap from '@kabegame/element-plus/components/focus-trap'
import { useGlobalComponentSettings } from '@kabegame/element-plus/components/config-provider'
