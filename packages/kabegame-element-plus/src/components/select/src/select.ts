...
import { scrollbarEmits } from '@kabegame/element-plus/components/scrollbar'
import {
  useAriaProps,
  useEmptyValuesProps,
  useSizeProp,
...
import { ArrowDown, CircleClose } from '@kabegame/element-plus-icons'
...
import { defaultProps } from '@kabegame/element-plus/components/select-v2/src/useProps'

import type { ClassValue, EmitFn } from '@kabegame/element-plus/utils'
...
import type {
  ...
  Placement,
  PopperEffect,
} from '@kabegame/element-plus/components/popper'
import type { OptionValue } from './type.ts'
import type { Props } from '@kabegame/element-plus/components/select-v2/src/useProps'
