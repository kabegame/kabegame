...
|---------|--------------|-----------|
| Windows | [setup.exe](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-standard_4.2.1_x64-setup.exe) | [setup.exe](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-light_4.2.1_x64-setup.exe) |
| macOS | [dmg 映像](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-standard_4.2.1_aarch64.dmg) | [dmg 映像](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-light_4.2.1_aarch64.dmg) |
| Linux | [deb 包](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-standard_4.2.1_amd64.deb) | [deb 包](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame-light_4.2.1_amd64.deb) |

- **安卓预览版**：[apk](https://github.com/kabegame/kabegame/releases/download/v4.2.1/Kabegame_4.2.1_android-preview.apk)（同一发布页）。
