...
| macOS | [dmg 映像](https://github.com/kabegame/kabegame/releases/download/v4.1.1/Kabegame-standard_4.1.1_aarch64.dmg) | [dmg 映像](https://github.com/kabegame/kabegame/releases/download/v4.1.1/Kabegame-light_4.1.1_aarch64.dmg) |
| Linux | [deb 包](https://github.com/kabegame/kabegame/releases/download/v4.1.1/Kabegame-standard_4.1.1_amd64.deb) | [deb 包](https://github.com/kabegame/kabegame/releases/download/v4.1.1/Kabegame-light_4.1.1_amd64.deb) |

- **安卓预览版**：[apk](https://github.com/kabegame/kabegame/releases/download/v4.1.1/Kabegame_4.1.1_android-preview.apk)（同一发布页）。
